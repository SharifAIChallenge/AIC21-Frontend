  ...
  <div>
    <div class="primary--bg primary pb-12">
      <div class="d-flex justify-center">
        <div
          class="p-absolute text-stroke-width-2 text-stroke-white transparent--text text-center font-family-chopsic"
        ...
        <v-row align="center">
          <v-col>
            <glow class="d-inline-block pe-3">
              <h2 id="about" class="display-3 white--text font-weight-black">
                {{ $t('home.ourTeam') }}
              </h2>
            </glow>
          </v-col>
    ...
    <v-container class="mt-n12 pb-12">
      <v-card class="mt-n3">
        <client-only>
          <v-tabs v-model="tabs" grow centered center-active show-arrows>
