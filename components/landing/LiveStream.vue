  ...
  <v-card class="overflow-hidden">
    ...
    <v-tabs-items v-model="tab" class="mt-4">
      <v-tab-item class="text-center">
        <iframe
          src="https://player.twitch.tv/?channel=ai_challenge"
          frameborder="0"
        ...
        />
        <a
          href="https://www.twitch.tv/ai_challenge?tt_content=text_link&tt_medium=live_embed"
          style="padding:2px 0px 4px; display:block; width:345px; font-weight:normal; font-size:10px; text-decoration:underline;"
        >
          Watch live video from AI_Challenge on www.twitch.tv
        </a>
      </v-tab-item>
      <v-tab-item>
        <iframe
