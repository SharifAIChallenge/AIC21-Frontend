  ...
  <v-container class="py-12">
    <v-row align="center">
      <v-col cols="12" md="5">
        ...
        <glow class="py-3">
          <span
            class="font-family-chopsic transparent--text text-stroke-white text-stroke-width-1 display-1"
          >
            AI Challenge
          </span>
        </glow>
      ...
      <v-col>
        <v-carousel
          ...
          vertical
        >
          <v-carousel-item v-for="(slide, i) in quotes" :key="i">
            <v-sheet height="100%" color="bg">
              <v-row class="fill-height px-10" align="center">
                <div>
                  ...
                  <div class="py-5" v-html="slide.comment_fa" />
